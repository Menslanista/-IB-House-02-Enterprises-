      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div>
                ...
                <div className="flex items-start group">
                    ...
                    <div>
                        ...
                        <p className="text-gray-400 mt-1">2 Jehovah Street,<br />Lagos, Nigeria</p>
                    </div>
                </div>
                <div className="flex items-start group">
                    <div className="bg-gray-800 p-4 rounded-xl mr-5 text-amber-500 group-hover:bg-amber-500 group-hover:text-black transition-colors duration-300 shadow-lg">
                    ...
                    <div>
                        ...
                        <p className="text-gray-400 mt-1">+234 XXX XXX XXXX</p>
                    </div>
                </div>
                <div className="flex items-start group">
                    <div className="bg-gray-800 p-4 rounded-xl mr-5 text-amber-500 group-hover:bg-amber-500 group-hover:text-black transition-colors duration-300 shadow-lg">
                    ...
                    <div>
                        ...
                        <p className="text-gray-400 mt-1">info@ibhouse02.com</p>
                    </div>
                </div>
                </div>
            </div>
          ...
          <div className="bg-gray-800/50 backdrop-blur-sm p-8 md:p-10 rounded-3xl shadow-2xl border border-gray-700">
            <h3 className="text-2xl font-bold mb-6 text-white border-l-4 border-amber-500 pl-4">Send us a Message</h3>
            ...
            {isSuccess ? (
              <div className="h-full flex flex-col items-center justify-center py-12 animate-fade-in">
                ...
                <p className="text-gray-400 text-center max-w-xs">We have received your message and will get back to you shortly.</p>
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="group">
                  ...
                  <input
                    ...
                    className={`w-full bg-gray-900 border ${errors.name ? 'border-red-500' : 'border-gray-700'} rounded-xl px-5 py-4 text-white focus:outline-none focus:border-amber-500 focus:ring-1 focus:ring-amber-500 transition-all`}
                    placeholder="John Doe"
                  />
                  {errors.name && <p className="text-red-400 text-xs mt-2 flex items-center ml-1"><AlertCircle size={12} className="mr-1"/> {errors.name}</p>}
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input
                            ...
                            value={form.email}
                            onChange={handleChange}
                            className={`w-full bg-gray-900 border ${errors.email ? 'border-red-500' : 'border-gray-700'} rounded-xl px-5 py-4 text-white focus:outline-none focus:border-amber-500 focus:ring-1 focus:ring-amber-500 transition-all`}
                            placeholder="john@example.com"
                        />
                        {errors.email && <p className="text-red-400 text-xs mt-2 flex items-center ml-1"><AlertCircle size={12} className="mr-1"/> {errors.email}</p>}
                    </div>
                    <div>
                        ...
                        <input
                            ...
                            value={form.phone}
                            onChange={handleChange}
                            className={`w-full bg-gray-900 border ${errors.phone ? 'border-red-500' : 'border-gray-700'} rounded-xl px-5 py-4 text-white focus:outline-none focus:border-amber-500 focus:ring-1 focus:ring-amber-500 transition-all`}
                            placeholder="+234..."
                        />
                        {errors.phone && <p className="text-red-400 text-xs mt-2 flex items-center ml-1"><AlertCircle size={12} className="mr-1"/> {errors.phone}</p>}
                    </div>
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    rows={4}
                    className={`w-full bg-gray-900 border ${errors.message ? 'border-red-500' : 'border-gray-700'} rounded-xl px-5 py-4 text-white focus:outline-none focus:border-amber-500 focus:ring-1 focus:ring-amber-500 transition-all resize-none`}
                    placeholder="Tell us about your stay requirements..."
                  ></textarea>
                  {errors.message && <p className="text-red-400 text-xs mt-2 flex items-center ml-1"><AlertCircle size={12} className="mr-1"/> {errors.message}</p>}
                </div>
