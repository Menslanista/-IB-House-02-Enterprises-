        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          <div className="sticky top-32">
            <h2 className="text-4xl md:text-5xl font-bold mb-6 text-white">
              Why Choose <br />
              <span className="bg-gradient-to-r from-amber-200 to-amber-600 bg-clip-text text-transparent">IB House 02?</span>
            </h2>
              ...
              >
                ...
                >
                  <div className="flex items-center gap-4">
                    <div className={`p-2 rounded-lg transition-colors ${openIndex === index ? 'bg-amber-500/10' : 'bg-gray-700/50 group-hover:bg-gray-700'}`}>
                       {getIcon(index)}
                    </div>
                    <span className={`text-xl font-bold transition-colors ${openIndex === index ? 'text-amber-400' : 'text-gray-200 group-hover:text-white'}`}>
                      {feature.title}
                    </span>
                  </div>
                  {openIndex === index ? (
